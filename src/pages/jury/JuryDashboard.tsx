...
export default function JuryDashboard() {
  ...
  if (loading) {
    return <div className="flex h-screen items-center justify-center bg-slate-950 text-white">Chargement des films...</div>;
  }
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-950">
      <aside className="hidden w-80 flex-col border-r border-slate-800 bg-slate-950 p-6 md:flex h-screen">
         
         <div className="mb-6 shrink-0">
           <h2 className="text-xl font-bold text-white">Interface Jury marsAI</h2>
           <p className="mt-1 text-sm text-primary">L'excellence au bout du curseur</p>
         </div>
      ...
      <main className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-x-scroll scrollbar p-4 md:p-8">
