...
function ValidateForm() {
    const newErrors: any = {};
    if (!formData.firstName) newErrors.firstName = t('submit.validation.required');
    if (!formData.lastName) newErrors.lastName = t('submit.validation.required');
    ...
    if (!formData.postalCode) newErrors.postalCode = t('submit.validation.required');
    ...
    if (!formData.profession) newErrors.profession = t('submit.validation.required');
