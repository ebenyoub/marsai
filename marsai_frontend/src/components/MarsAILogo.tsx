    ...
    <Link to="/" className="group flex items-center gap-3">
      ...
      <div className="relative h-12 w-auto">
        ...
        >
          ...
          {/* Tagline */}
          <text x="32" y="40" fill="#6B7280" fontSize="6" fontFamily="Inter, sans-serif" fontWeight="400" opacity="0.8">
            Marseille 2026
          </text>
        </svg>

        {/* Hover glow effect */}
        <div className="bg-primary/10 pointer-events-none absolute inset-0 rounded-full opacity-0 blur-xl transition-opacity group-hover:opacity-100" />
      </div>
    </Link>
  );
}
