...
// const findAll = (callback: MovieArrayCallback) => {
//   const sql = 'SELECT * FROM movie';
//   db.query(sql, callback);
// };

// const getById = (id: Movie, callback: MovieCallback) => {
//   const sql = 'SELECT * FROM movie WHERE id = ?';
//   db.query<Movie[]>(sql, [id], callback);
// };

// const create = (movie: Movie, callback: MovieCallback) => {
//   const sql =
...
// const edit = (id, movie: Movie, callback) => {
//   const sql =
